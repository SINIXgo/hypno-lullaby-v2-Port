function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'leanmonster_Nota_Animacion' then --Check if the note on the chart is a Bullet Note
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'leanmonster_Nota_Animacion' then
