...
local textureSplash = 'pixelUI/splash-brimstone';
...
function spawnCustomSplash(noteId, noteDirection, type,textureNote)
	...
	addAnimationByPrefix('noteSplash'..splashCount, 'anim', splashThing, splashVelocity, false);
		setProperty('noteSplash' .. splashCount .. '.scale.x', 3);
		setProperty('noteSplash' .. splashCount .. '.scale.y', 3);
	setProperty('noteSplash' .. splashCount .. '.offset.x', -15);
	setProperty('noteSplash' .. splashCount .. '.offset.y', -20);
